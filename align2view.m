function pair = align2view(data, frameID_i, frameID_j)
...
XYZcam_i = depth2XYZcamera(data.K, depthRead(data.depth{frameID_i}));
XYZcam_j = depth2XYZcamera(data.K, depthRead(data.depth{frameID_j}));
